...
export function ProfanityWarningModal({
  ...
  if (import.meta.env.DEV) {
    console.log('ProfanityWarningModal render - open:', open, 'profanityFields:', profanityFields, 'container:', container)
  }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-[75vw] max-h-[75vh] w-full overflow-y-auto rounded-lg border-2 border-destructive bg-background/70 p-6 shadow-lg"
        showCloseButton
